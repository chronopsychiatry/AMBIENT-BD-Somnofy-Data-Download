...
A pattern that can be used to exclude some subjects from the download based on their identifier.

- `exclude-subjects=Test` will exclude all subjects that have "Test" in their identifier (e.g. "Test ABD123" or "ABD123 Test")
- `exclude-subjects=*` will download all available subject (for the zone, device and subject lists specified)
